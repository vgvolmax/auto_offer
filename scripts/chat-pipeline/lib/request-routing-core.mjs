import { jsonDeepEqual } from '../../lib/json-contract-utils.mjs';
...
export function validateRequestRoutingObjects(routing, requestSource, taxonomyLight, validators = {}) {
  ...
  if (!jsonDeepEqual(routeIds, sourceIds)) errors.push('routing routes must cover source line_ids exactly once and preserve source order');
