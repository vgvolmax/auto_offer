...
const renderLine = (overrides: Partial<MatchLineReviewView>) => {
  ...
  render(<MatchLineCard line={line} expanded feedbackOpen={false} disabled={false} saving={false} onToggle={vi.fn()} onSelect={vi.fn()} onClear={vi.fn()} onNoOffer={vi.fn()} onFeedbackOpenChange={vi.fn()} onSaveFeedback={vi.fn()} onClearFeedback={vi.fn()} />);
};
